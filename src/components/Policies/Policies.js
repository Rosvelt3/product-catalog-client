...
const Policies = () => {
  return (
    <>
      <Navigation />
      <Container>
        <h1 className="pt-5">Política de privacidad</h1>
        <p>&nbsp;</p>
        <p>
          La presente Política de Privacidad establece los términos en que Mi
          catalogo usa y protege la información que es proporcionada por sus
        ...
        <p>
          Mi catalogo está altamente comprometido para cumplir con el compromiso
        ...
        <p>
          Mi catalogo Se reserva el derecho de cambiar los términos de la
